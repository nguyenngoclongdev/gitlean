...
export abstract class WebviewBase implements Disposable {
					...
					switch (params.type) {
						case 'commit': {
							const commit = new GitBlameCommit(
								'~/code/nguyenngoclongdev/vscode-gitlean-demo',
								'fe26af408293cba5b4bfd77306e1ac9ff7ccaef8',
								'You',
								'nguyenngoclongdev@gmail.com',
							...
							if (includePullRequest) {
								pr = new PullRequest(
									{ id: 'github', name: 'GitHub', domain: 'github.com' },
									{
										...
										url: 'https://github.com/nguyenngoclongdev',
									},
									'1',
									'Supercharged',
									'https://github.com/nguyenngoclongdev/vscode-gitlean/pulls/1',
	...
	async show(column: ViewColumn = ViewColumn.Beside): Promise<void> {
		if (this._panel == null) {
			...
			this._panel.iconPath = Uri.file(Container.context.asAbsolutePath('images/gitlean-icon.png'));
