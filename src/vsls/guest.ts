...
export class VslsGuestService implements Disposable {
	...
	private onAvailabilityChanged(available: boolean) {
		...
		void window.showWarningMessage(
			'GitLean features will be unavailable. Unable to connect to the host GitLean service. The host may have disabled GitLean guest access or may not have GitLean installed.',
		);
	}
