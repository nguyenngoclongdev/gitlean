...
// TODO@nguyenngoclongdev revisit how once authenticated, all remotes are always connected, even after a restart
...
export abstract class RichRemoteProvider extends RemoteProvider {
	...
	constructor(domain: string, path: string, protocol?: string, name?: string, custom?: boolean) {
		...
		Container.context.subscriptions.push(
			// TODO@nguyenngoclongdev revisit how connections are linked or not
