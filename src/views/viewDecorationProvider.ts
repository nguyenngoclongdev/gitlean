		...
		this.disposable = Disposable.from(
			...
			window.registerFileDecorationProvider({
				provideFileDecoration: (uri, token) => {
					if (uri.scheme !== 'gitlean-view') return undefined;
	...
	provideCommitFileStatusDecoration(uri: Uri, _token: CancellationToken): FileDecoration | undefined {
		...
		switch (status) {
			case '!':
				return {
					badge: 'I',
					color: new ThemeColor('gitlean.decorations.ignoredForegroundColor'),
					tooltip: 'Ignored',
				};
			case '?':
				return {
					badge: 'U',
					color: new ThemeColor('gitlean.decorations.untrackedForegroundColor'),
					tooltip: 'Untracked',
				};
			case 'A':
				return {
					badge: 'A',
					color: new ThemeColor('gitlean.decorations.addedForegroundColor'),
					tooltip: 'Added',
				};
			case 'C':
				return {
					badge: 'C',
					color: new ThemeColor('gitlean.decorations.copiedForegroundColor'),
					tooltip: 'Copied',
				};
			case 'D':
				return {
					badge: 'D',
					color: new ThemeColor('gitlean.decorations.deletedForegroundColor'),
					tooltip: 'Deleted',
				};
			case 'M':
				return {
					badge: 'M',
					// color: new ThemeColor('gitlean.decorations.modifiedForegroundColor'),
					tooltip: 'Modified',
				};
			case 'R':
				return {
					badge: 'R',
					color: new ThemeColor('gitlean.decorations.renamedForegroundColor'),
					tooltip: 'Renamed',
				};
			default:
				return undefined;
	...
	provideBranchStatusDecoration(uri: Uri, _token: CancellationToken): FileDecoration | undefined {
		...
		switch (status as GitBranchStatus) {
			case GitBranchStatus.Ahead:
				return {
					badge: '▲',
					color: new ThemeColor('gitlean.decorations.branchAheadForegroundColor'),
					tooltip: 'Ahead',
				};
			case GitBranchStatus.Behind:
				return {
					badge: '▼',
					color: new ThemeColor('gitlean.decorations.branchBehindForegroundColor'),
					tooltip: 'Behind',
				};
			case GitBranchStatus.Diverged:
				return {
					badge: '▼▲',
					color: new ThemeColor('gitlean.decorations.branchDivergedForegroundColor'),
					tooltip: 'Diverged',
				};
			case GitBranchStatus.MissingUpstream:
				return {
					badge: '!',
					color: new ThemeColor('gitlean.decorations.branchMissingUpstreamForegroundColor'),
					tooltip: 'Missing Upstream',
				};
			case GitBranchStatus.UpToDate:
				return {
					badge: '',
					color: new ThemeColor('gitlean.decorations.branchUpToDateForegroundColor'),
					tooltip: 'Up to Date',
				};
			case GitBranchStatus.Unpublished:
				return {
					badge: '▲+',
					color: new ThemeColor('gitlean.decorations.branchUnpublishedForegroundColor'),
					tooltip: 'Unpublished',
				};
			default:
				return undefined;
