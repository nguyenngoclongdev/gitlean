...
export enum ContextValues {
	ActiveFileHistory = 'gitlean:history:active:file',
	ActiveLineHistory = 'gitlean:history:active:line',
	Branch = 'gitlean:branch',
	Branches = 'gitlean:branches',
	BranchStatusAheadOfUpstream = 'gitlean:status-branch:upstream:ahead',
	BranchStatusBehindUpstream = 'gitlean:status-branch:upstream:behind',
	BranchStatusNoUpstream = 'gitlean:status-branch:upstream:none',
	BranchStatusSameAsUpstream = 'gitlean:status-branch:upstream:same',
	BranchStatusFiles = 'gitlean:status-branch:files',
	Commit = 'gitlean:commit',
	Commits = 'gitlean:commits',
	Compare = 'gitlean:compare',
	CompareBranch = 'gitlean:compare:branch',
	ComparePicker = 'gitlean:compare:picker',
	ComparePickerWithRef = 'gitlean:compare:picker:ref',
	CompareResults = 'gitlean:compare:results',
	CompareResultsCommits = 'gitlean:compare:results:commits',
	Contributor = 'gitlean:contributor',
	Contributors = 'gitlean:contributors',
	DateMarker = 'gitlean:date-marker',
	File = 'gitlean:file',
	FileHistory = 'gitlean:history:file',
	Folder = 'gitlean:folder',
	LineHistory = 'gitlean:history:line',
	Merge = 'gitlean:merge',
	MergeConflictCurrentChanges = 'gitlean:merge-conflict:current',
	MergeConflictIncomingChanges = 'gitlean:merge-conflict:incoming',
	Message = 'gitlean:message',
	Pager = 'gitlean:pager',
	PullRequest = 'gitlean:pullrequest',
	Rebase = 'gitlean:rebase',
	Reflog = 'gitlean:reflog',
	ReflogRecord = 'gitlean:reflog-record',
	Remote = 'gitlean:remote',
	Remotes = 'gitlean:remotes',
	Repositories = 'gitlean:repositories',
	Repository = 'gitlean:repository',
	RepositoryFolder = 'gitlean:repo-folder',
	ResultsFile = 'gitlean:file:results',
	ResultsFiles = 'gitlean:results:files',
	SearchAndCompare = 'gitlean:searchAndCompare',
	SearchResults = 'gitlean:search:results',
	SearchResultsCommits = 'gitlean:search:results:commits',
	Stash = 'gitlean:stash',
	Stashes = 'gitlean:stashes',
	StatusFileCommits = 'gitlean:status:file:commits',
	StatusFiles = 'gitlean:status:files',
	StatusAheadOfUpstream = 'gitlean:status:upstream:ahead',
	StatusBehindUpstream = 'gitlean:status:upstream:behind',
	StatusNoUpstream = 'gitlean:status:upstream:none',
	StatusSameAsUpstream = 'gitlean:status:upstream:same',
	Tag = 'gitlean:tag',
	Tags = 'gitlean:tags',
}
...
> extends SubscribeableViewNode<TView> {
	...
	static getId(repoPath: string): string {
		return `gitlean${this.key}(${repoPath})`;
	}
