...
import type { CreatePullRequestActionContext, OpenPullRequestActionContext } from '../api/gitlean';
import {
	Commands,
	DiffWithCommandArgs,
...
export class ViewCommands {
	constructor() {
		commands.registerCommand('gitlean.views.clearNode', (n: ViewNode) => canClearNode(n) && n.clear(), this);
		...
		commands.registerCommand(
			'gitlean.views.dismissNode',
			(n: ViewNode) => canViewDismissNode(n.view) && n.view.dismissNode(n),
			this,
		);
		commands.registerCommand('gitlean.views.editNode', (n: ViewNode) => canEditNode(n) && n.edit(), this);
		commands.registerCommand(
			'gitlean.views.expandNode',
			(n: ViewNode) => n.view.reveal(n, { select: false, focus: false, expand: 3 }),
			this,
		);
		commands.registerCommand('gitlean.views.loadMoreChildren', (n: PagerNode) => n.loadMore(), this);
		commands.registerCommand('gitlean.views.loadAllChildren', (n: PagerNode) => n.loadAll(), this);
		commands.registerCommand(
			'gitlean.views.refreshNode',
		...
		commands.registerCommand(
			'gitlean.views.setShowRelativeDateMarkersOn',
			() => this.setShowRelativeDateMarkers(true),
			this,
		);
		commands.registerCommand(
			'gitlean.views.setShowRelativeDateMarkersOff',
			() => this.setShowRelativeDateMarkers(false),
			this,
		);

		commands.registerCommand('gitlean.views.fetch', this.fetch, this);
		commands.registerCommand('gitlean.views.publishBranch', this.publishBranch, this);
		commands.registerCommand('gitlean.views.publishRepository', this.publishRepository, this);
		commands.registerCommand('gitlean.views.pull', this.pull, this);
		commands.registerCommand('gitlean.views.push', this.push, this);
		commands.registerCommand('gitlean.views.pushWithForce', n => this.push(n, true), this);
		commands.registerCommand('gitlean.views.closeRepository', this.closeRepository, this);

		commands.registerCommand('gitlean.views.setAsDefault', this.setAsDefault, this);
		commands.registerCommand('gitlean.views.unsetAsDefault', this.unsetAsDefault, this);

		commands.registerCommand('gitlean.views.openInTerminal', this.openInTerminal, this);
		commands.registerCommand('gitlean.views.star', this.star, this);
		commands.registerCommand('gitlean.views.unstar', this.unstar, this);

		commands.registerCommand('gitlean.views.browseRepoAtRevision', this.browseRepoAtRevision, this);
		commands.registerCommand(
			'gitlean.views.browseRepoAtRevisionInNewWindow',
			n => this.browseRepoAtRevision(n, { openInNewWindow: true }),
			this,
		);
		commands.registerCommand(
			'gitlean.views.browseRepoBeforeRevision',
			n => this.browseRepoAtRevision(n, { before: true }),
			this,
		);
		commands.registerCommand(
			'gitlean.views.browseRepoBeforeRevisionInNewWindow',
			n => this.browseRepoAtRevision(n, { before: true, openInNewWindow: true }),
			this,
		);

		commands.registerCommand('gitlean.views.addAuthors', this.addAuthors, this);
		commands.registerCommand('gitlean.views.addAuthor', this.addAuthors, this);

		commands.registerCommand('gitlean.views.openChanges', this.openChanges, this);
		commands.registerCommand('gitlean.views.openChangesWithWorking', this.openChangesWithWorking, this);
		commands.registerCommand(
			'gitlean.views.openPreviousChangesWithWorking',
			this.openPreviousChangesWithWorking,
			this,
		);
		commands.registerCommand('gitlean.views.openFile', this.openFile, this);
		commands.registerCommand('gitlean.views.openFileRevision', this.openRevision, this);
		commands.registerCommand('gitlean.views.openChangedFiles', this.openFiles, this);
		commands.registerCommand('gitlean.views.openChangedFileDiffs', this.openAllChanges, this);
		commands.registerCommand('gitlean.views.openChangedFileDiffsWithWorking', this.openAllChangesWithWorking, this);
		commands.registerCommand('gitlean.views.openChangedFileRevisions', this.openRevisions, this);
		commands.registerCommand('gitlean.views.applyChanges', this.applyChanges, this);
		commands.registerCommand('gitlean.views.highlightChanges', this.highlightChanges, this);
		commands.registerCommand('gitlean.views.highlightRevisionChanges', this.highlightRevisionChanges, this);
		commands.registerCommand('gitlean.views.restore', this.restore, this);
		commands.registerCommand('gitlean.views.switchToBranch', this.switch, this);
		commands.registerCommand('gitlean.views.switchToAnotherBranch', this.switch, this);
		commands.registerCommand('gitlean.views.switchToCommit', this.switch, this);
		commands.registerCommand('gitlean.views.switchToTag', this.switch, this);
		commands.registerCommand('gitlean.views.addRemote', this.addRemote, this);
		commands.registerCommand('gitlean.views.pruneRemote', this.pruneRemote, this);

		commands.registerCommand('gitlean.views.stageDirectory', this.stageDirectory, this);
		commands.registerCommand('gitlean.views.stageFile', this.stageFile, this);
		commands.registerCommand('gitlean.views.unstageDirectory', this.unstageDirectory, this);
		commands.registerCommand('gitlean.views.unstageFile', this.unstageFile, this);

		commands.registerCommand('gitlean.views.compareAncestryWithWorking', this.compareAncestryWithWorking, this);
		commands.registerCommand('gitlean.views.compareWithHead', this.compareHeadWith, this);
		commands.registerCommand('gitlean.views.compareWithUpstream', this.compareWithUpstream, this);
		commands.registerCommand('gitlean.views.compareWithSelected', this.compareWithSelected, this);
		commands.registerCommand('gitlean.views.selectForCompare', this.selectForCompare, this);
		commands.registerCommand('gitlean.views.compareFileWithSelected', this.compareFileWithSelected, this);
		commands.registerCommand('gitlean.views.selectFileForCompare', this.selectFileForCompare, this);
		commands.registerCommand('gitlean.views.compareWithWorking', this.compareWorkingWith, this);

		commands.registerCommand(
			'gitlean.views.setBranchComparisonToWorking',
			n => this.setBranchComparison(n, ViewShowBranchComparison.Working),
			this,
		);
		commands.registerCommand(
			'gitlean.views.setBranchComparisonToBranch',
			n => this.setBranchComparison(n, ViewShowBranchComparison.Branch),
			this,
		);

		commands.registerCommand('gitlean.views.cherryPick', this.cherryPick, this);
		commands.registerCommand('gitlean.views.createBranch', this.createBranch, this);
		commands.registerCommand('gitlean.views.deleteBranch', this.deleteBranch, this);
		commands.registerCommand('gitlean.views.renameBranch', this.renameBranch, this);
		commands.registerCommand('gitlean.views.deleteStash', this.deleteStash, this);
		commands.registerCommand('gitlean.views.createTag', this.createTag, this);
		commands.registerCommand('gitlean.views.deleteTag', this.deleteTag, this);

		commands.registerCommand('gitlean.views.mergeBranchInto', this.merge, this);
		commands.registerCommand('gitlean.views.pushToCommit', this.pushToCommit, this);

		commands.registerCommand('gitlean.views.rebaseOntoBranch', this.rebase, this);
		commands.registerCommand('gitlean.views.rebaseOntoUpstream', this.rebaseToRemote, this);
		commands.registerCommand('gitlean.views.rebaseOntoCommit', this.rebase, this);

		commands.registerCommand('gitlean.views.resetCommit', this.resetCommit, this);
		commands.registerCommand('gitlean.views.resetToCommit', this.resetToCommit, this);
		commands.registerCommand('gitlean.views.revert', this.revert, this);
		commands.registerCommand('gitlean.views.undoCommit', this.undoCommit, this);

		commands.registerCommand('gitlean.views.terminalRemoveRemote', this.terminalRemoveRemote, this);

		commands.registerCommand('gitlean.views.createPullRequest', this.createPullRequest, this);
		commands.registerCommand('gitlean.views.openPullRequest', this.openPullRequest, this);
	}
	...
	private openChanges(node: ViewRefFileNode | MergeConflictFileNode | StatusFileNode) {
		...
		// TODO@nguyenngoclongdev Revisit this
