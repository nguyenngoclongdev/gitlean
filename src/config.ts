...
export enum CodeLensCommand {
	...
	CopyRemoteFileUrl = 'gitlean.copyRemoteFileUrl',
	...
	ShowQuickCommitDetails = 'gitlean.showQuickCommitDetails',
	ShowQuickCommitFileDetails = 'gitlean.showQuickCommitFileDetails',
